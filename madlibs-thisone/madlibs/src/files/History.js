...
const History = ( { formData, toggle } ) =>
{
    ...
    if ( toggle )
    {
        ...
        history = [
            ...
            [ `There was a  ${ formData.adj2 } ${ formData.noun2 } who loved a ${ formData.adj } ${ formData.noun }.This love was imposible because the families of the lovers where enemies since the beginning of times. Will love prevail ?. ` ],
            ...
            [ `In the early 1800 ${ formData.adj } ${ formData.noun } created one of the greatest empires in the world. In the other side of the world  the great King of sea  the ${ formData.adj2 } ${ formData.noun2 } was getting ready to conquer ${ formData.noun }'s part of the world. Who will be victoriouss , land or sea ? . ` ],
